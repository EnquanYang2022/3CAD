...
```
#### Prepare DTD dataset.
If you use **DTD** dataset for anomaly synthesis, Please download and extract it to your path. Modify the **dtd_path** in [train_utils/toolbox/utils.py](train_utils/toolbox/utils.py) to the path where you extracted it.
